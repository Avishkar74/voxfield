...
export function SupervisorDashboardContainer({ initialData }: SupervisorDashboardContainerProps) {
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <section id="alerts" className="scroll-mt-24 bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden">
      ...
      <section id="activity" className="scroll-mt-24 bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden flex flex-col h-[420px]">
